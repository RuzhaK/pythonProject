...
while line != "END":
    ...
    if command == "Change":
        ...
        list_to_check=paintings

        #  ako ima po dwa? sega raboti za wsichki, da probwam da raboti samo za savpadashta broika
        while painting_exists(painting_num, list_to_check) and painting_exists(painting_two,list_to_check):
            ...
            list_to_check=paintings[index_first:]
    elif command == "Insert":
        place = int(tokens[0])
        painting = tokens[1]
